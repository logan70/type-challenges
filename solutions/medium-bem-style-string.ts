...
type BEM<B extends string, E extends string[], M extends string[], T = E[number], K = M[number]> = `${B}${
  E['length'] extends 0
    ? ''
    : E[number] extends ''
      ? ''
...
type cases = [
  ...
  Expect<Equal<BEM<'btn', ['price'], ['warning', 'warning', 'success']>, 'btn__price--warning' | 'btn__price--success' >>,
