...
type Fibonacci<T extends number, Prev extends any[] = [], Current extends any[] = [any], Depth extends any[] = [any]> = T extends Depth['length']
    ? Current['length']
    : Fibonacci<T, Current, [...Prev, ...Current], [...Depth, any]>;
