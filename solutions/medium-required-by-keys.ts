...
type MergeObjects<T> = Omit<T, never>

type RequiredByKeys<T, K = keyof T> = MergeObjects<Omit<T, Extract<keyof T, K>> & Required<Pick<T, Extract<K, keyof T>>>>

type RequiredByKeys2<T, K = keyof T> = MergeObjects<Omit<T, Extract<keyof T, K>> & {
