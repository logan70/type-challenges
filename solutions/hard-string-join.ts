...
type JoinStr<Delimiter extends string, T extends string[]> = T extends [infer F extends string, ...infer R extends string[]]
  ? R extends []
    ? F
    : `${F}${Delimiter}${JoinStr<Delimiter, R>}`
  : ''

declare function join<T extends string>(delimiter: T): <R extends string[]>(...parts: R) => JoinStr<T, R>
