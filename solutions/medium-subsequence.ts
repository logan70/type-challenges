...
type Subsequence<T extends any[], Prefix extends any[] = [], K extends any[] =  []> =  T extends [infer F, ...infer R]
  ? K | Subsequence<R, Prefix, [...K, F]> | Subsequence<R, [...Prefix, F], K>
  : K;

type test = Subsequence<[1, 2, 3]>
