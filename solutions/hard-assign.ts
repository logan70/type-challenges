...
type AssignSingle<T extends Record<string, unknown>, U> = U extends Record<string, unknown> ? {
...
type Assign<T extends Record<string, unknown>, U> = U extends [infer F, ...infer R]
  ? Assign<AssignSingle<T, F>, R>
  : T;
